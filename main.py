...
async def main(page: ft.Page, args=None) -> None:
    ...
    # Force Dark Mode for the new Modern Design
    page.theme_mode = ft.ThemeMode.DARK
    page.bgcolor = "#1a1b26" # ColorPalette.BACKGROUND
...
if __name__ == "__main__":
    ...
    async def main_wrapper(page):
        await main(page, args)

    multiprocessing.freeze_support()
    if args.web or env_platform == "web":
        ft.app(target=main_wrapper, view=ft.WEB_BROWSER, host=args.host, port=args.port, assets_dir=ASSETS_DIR, web_renderer=ft.WebRenderer.CANVAS_KIT)
    else:
        ft.app(target=main_wrapper, assets_dir=ASSETS_DIR)
